...
const NewAppointmentCardPhysician = (props) => {
      ...
      {props.data?.items?.map((data, index) => {
        return (
          <div className="col-md-12">
            ...
            <div className="card shadow px-3 mt-1">
              <div className="row">
                <div className="col-lg-2 col-md-3 col-sm-3 my-5 text-info font-weight-bold  text-center">
                  {/* <FormControlLabel
                               control={
                                <Switch
                            ...
                            /> */}
                  {/* <h3>{data.isConfirm == 1  ? ( <span>Confirmed ✔</span> ) : (<span>Unconfirmed ✘</span>)}</h3> */}
                  <h5 className="m-0  font-weight-bold ">
                    {translate("VISIT_ID")}: {data.id}{" "}
                  </h5>
                  <h5 className="m-0 font-weight-bold pt-1">
                ...
                <div className="col-lg-6 col-md-6 col-sm-6 my-1 border-left font-weight-bold">
                  <div>
                    <p className="text-dark font-weight-bold h5 m-0">
                      {data.title}
                    </p>
                    <p className="text-dark font-weight-bold h5 m-0 float-right">
                      {"( "}
                      {data.meetingtype}
                      {" meeting )"}
                  ...
                  <div className="d-flex align-items-center pt-3">
                    ...
                    <div className="col-lg-7 col-md-6 col-sm-6">
                      <button
                        className={`w-100 btn btn-sm cc-btn mb-2 ${
                      ...
                      <button
                        className="w-100 btn btn-sm cc-btn"
                        onClick={() => {
                          {
                ...
                <div className="col-lg-4 col-md-6 col-sm-6 my-3 border-left pr-md-4 text-center">
                  {showPre ? (
                    <button
...
export default NewAppointmentCardPhysician;
