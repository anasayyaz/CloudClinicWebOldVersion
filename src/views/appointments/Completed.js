...
import CompletedVisitsCard from "./CompletedVisitsCard";
...
class Completed extends React.Component {
  ...
  getLatest(confirmStatus) {
    ...
    if (confirmStatus == "All") {
      list("visit/CompletedVisitsList", {
        ...
        this.setState({ rowData: response.data });
        this.setState({sum: 0})
        for (let i = 0; i < response.data.paginationMetadata.totalCount; i++) {
  ...
  handleSearchClick(request, $class) {
    ...
    list("visit/CompletedVisitsList", requestData).then((response) => {
      this.setState({ rowData: response.data });
      //  alert(response.data.paginationMetadata.totalCount)
      this.setState({sum: 0})
      ...
      >
        ...
        <NoPrint>
          ...
          <div
              ...
              className=" px-2 py-2  col-md-2   border-0  float-right d-flex justify-content-end"
            >
              <p>Total Amount: {this.state.sum}</p>
            </div>
            <div
              style={{ borderRadius: "1rem" }}
          ...
          <div className="mt-3 d-flex justify-content-between">
            <h4 className="m-0">Completed Appointments</h4>
