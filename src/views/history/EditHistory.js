...
export default class EditHistory extends React.Component {
...
<h4>IV - {translate("CURRENT_MEDICATION")}</h4>
 ...
 <div className="input-container">
              ...
              value={this.state.currentMedications}
                              ...
                              <div className="input-container">
                               <input type="text" onChange={this.handleChange}   value={this.state.medicineFrequency} id="medicineFrequency" required  />  <label>{translate("FREQUENCY")}</label> 
                               </div> 
                              <div className="input-container">
           <input type="text" onChange={this.handleChange}  value={this.state.medicineDosage}   id="medicineDosage" required  /><label>{translate("DOSAGE")}</label> 
           </div> 
                              <div className="input-container">
            <input type="text" onChange={this.handleChange}  value={this.state.medicineForm} id="medicineForm" required  /><label>{translate("FORM")}</label> 
      ...
      <div className="input-container">    
        ...
        <div className="form-group">
          ...
          <div>
           ...
           id="numberofpregnancies" required placeholder={translate("NUMBER_OF_PREGNANCIES")} />
      </div>
           </div>
                <div className="col-md-4">
                <div className="input-container">        
           <input type="text" onChange={this.handleChange}   
           id="ageatmenstruation" required placeholder={translate("AGE_AT_MENSTURATION")} />
      </div>
           </div>
              <div className="col-md-4">
                <div className="input-container">      
           <input type="text" onChange={this.handleChange}  
           id="ageofmenopaise" required placeholder={translate("AGE_AT_MENOPAUSE")} />
      </div>
           </div>
           ...
           <div class="row" style={{paddingTop:"10px"}}>  
               <div className="col-md-4">
                <div className="input-container">      
           <input type="text" onChange={this.handleChange}    
           id="lastmenstrualperiod" required placeholder={translate("LAST_MENSTRUAL_PERIOD")} />
      </div>
           </div>
                <div className="col-md-4">
                <div className="input-container">         
           <input type="text" onChange={this.handleChange}    id="lastpapsmear" required 
           placeholder={translate("LAST_PAP_SMEAR")} />
      </div>
           </div>
                <div className="col-md-4">
                <div className="input-container">         
           <input type="text" onChange={this.handleChange}    id="lastmemogram" required 
