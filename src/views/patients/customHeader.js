...
CustomHeader.prototype.init = function (agParams) {
    ...
    this.eGui.innerHTML =
        '' +
        '<div className="customHeaderMenuButton"><i className="fa ' +
        this.agParams.menuIcon +
        '"></i></div>' +
        '<div className="customHeaderLabel">' +
        this.agParams.displayName +
        '</div>' +
        '<div className="customSortDownLabel inactive"><i className="fa fa-long-arrow-alt-down"></i></div>' +
        '<div className="customSortUpLabel inactive"><i className="fa fa-long-arrow-alt-up"></i></div>' +
        '<div className="customSortRemoveLabel inactive"><i className="fa fa-times"></i></div>';
