...
let choiceValue;
let descriptionType;
class TodayVisits extends React.Component {
  ...
  setConfirm = (id, value) => {
    ...
    // list(
    //   "/patient/patientsTodayVisitsFilter?pageNumber=1&pageSize=10&QuerySearch=",
    //   {
    //     pageNumber: 1,
    //     pageSize: 10,
    //     QuerySearch: "",
  ...
  handleSearchClick(request, $class) {
    ...
    //  alert(lid);
    list("patient/patientsTodayVisitsFilter", requestData).then((response) => {
      this.setState({ rowData: response.data });
    });
...
export default connect(mapStateToProps)(TodayVisits);
